...
export default function Notavialable() {
      ...
      <Modal visible={modalOpen} animationType="slide" transparent={true}>
        <View style={ModalStyles.content}>
          ...
          <Image
            ...
            source={require('_assets/images/sad.png')}
          />
          <Text style={ModalStyles.headingText}>Not Available </Text>
          <Text style={ModalStyles.subheadText}>
            Sorry we're not serving at this location.
          </Text>
          <Text>_____________________________________________</Text>
          <TouchableOpacity>
            <Text style={ModalStyles.endText}>Go to Home</Text>
          </TouchableOpacity>
