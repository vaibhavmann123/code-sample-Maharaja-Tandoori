...
export default function NotDelivery() {
      ...
      <Modal visible={modalOpen} animationType="slide" transparent={true}>
        <View style={ModalStyles.content}>
          ...
          <Text style={ModalStyles.subheadText}>
            Sorry we're currently not taking delivery orders.
          </Text>
          <Text>_____________________________________________</Text>
          <View style={{marginTop: 16}}>
            <Button text="Want to Pickup?"></Button>
          </View>
          <TouchableOpacity>
            <Text style={ModalStyles.endText}>Change Delivery Time</Text>
          </TouchableOpacity>
